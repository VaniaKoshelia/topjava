...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredWithExcessByDateTime(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return getFilteredWithExcess(meals, caloriesPerDay, m -> DateTimeUtil.isBetweenDates(m.getDate(), startDate, endDate) && DateTimeUtil.isBetween(m.getTime(), startTime, endTime));
    }
