...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        ...
        return namedParameterJdbcTemplate.query("SELECT * FROM meals where date_time BETWEEN :startDate::timestamp AND :endDate::timestamp AND user_id=:userId ORDER BY date_time", map, ROW_MAPPER);
    }
}
